# This script is the Golden Standard.
...
sh = gc.open("bitcoin_extractions")  # We are opening a worksheet.
...
schedule.every(45).seconds.do(extract_and_populate)
while True:  # This is of course an infinite loop
